  ...
  <main class="main">
    ...
    <section class="grid-section">
      <div class="grid">
        <div class="card">
          👥 Total Customers
          <button class="detail-btn" onclick="window.location.href='Customer'">View Details</button>
        </div>
        <div class="card">
          📦 Total Items
          <button class="detail-btn" onclick="window.location.href='Item'">View Details</button>
        </div>
        <div class="card">
          🧾 Bills Generated Today
          <button class="detail-btn" onclick="window.location.href='BillingPage'">View Details</button>
        </div>
        <div class="card">
          🆕 New Customers Today
          <button class="detail-btn" onclick="window.location.href='Customer'">View Details</button>
        ...
        <div class="card">
          🗂️ Account Details
          <button class="detail-btn" onclick="window.location.href='AccountDetails'">View Details</button>
        </div>
        <div class="card">
          ➕ Add Customer
          <button class="detail-btn" onclick="window.location.href='Customer'">View Details</button>
        ...
        <div class="card">
          📘 Open Help Guide
          <button class="detail-btn" onclick="window.location.href='help.jsp'">View Details</button>
        </div>
        <div class="card">
          📦 Orders
          <button class="detail-btn" onclick="window.location.href='Order'">View Details</button>
        </div>
      </div>
    </section>
  </main>
